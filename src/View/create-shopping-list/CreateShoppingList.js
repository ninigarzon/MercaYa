        ...
        <div style={{ background: "#DDF1FC" }} >
            <div className="ml-5 pt-5" style={{ height: "91vh" }}>
                ...
                <Container>
                    <Row>
                        <Col lg={12}>
                            <h1 className="titleHomeIn">Ingrese un producto a su lista de compras</h1>
                        </Col>
                    </Row>
                    <div className='container-inputs'>
                        <div className='first flex-inputs'>
                            <label className='label-input'>Nombre de la lista</label>
                            <input className='input' type="text" placeholder="Ingrese el nombre de la lista" />
                        </div>
                        ...
                        <div className='fourth flex-inputs'>
                            <label className='label-input'>¿En que supermercado deseas comprar?</label>
                            <select className='input'>
                                <option>Seleccione...</option>
                                <option>Opción 1</option>
                                <option>Opción 2</option>
